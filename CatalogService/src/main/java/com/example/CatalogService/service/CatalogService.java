...
//        searchClient.addTagCache(dto);
        ...
        EdaMessage.ProductTags message = EdaMessage.ProductTags.newBuilder().setProductId(product.id).addAllTags(tags).build();
...
//            searchClient.removeTagCache(dto);
            ...
            EdaMessage.ProductTags message = EdaMessage.ProductTags.newBuilder().setProductId(product.get().id).addAllTags(product.get().tags).build();
